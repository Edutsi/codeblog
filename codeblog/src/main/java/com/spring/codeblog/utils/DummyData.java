...
public class DummyData {
    ...
    @Autowired//Pirmeira coisa a fazer é criar o ponto de injeção CodeblogRepitory
    CodeblogRepository codeblogRepitory;
    

   //* @PostConstruct//tudo que colocar nesse metodo vai sendo anotado conforme a app sobe - fica comentado pra nao
   //gerar dois posts toda vez q iniciar a app
    public void savePosts(){
        ...
        for(Post post: postList){
            Post postSaved = codeblogRepitory.save(post);
